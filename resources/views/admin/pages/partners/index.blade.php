            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-user"></i>اضافه شريط جديد</div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <form  action="{{ route('admin.partners') }}" enctype="multipart/form-data" method="post"  onsubmit="return false;">
                            {!! csrf_field() !!}
                            <div class="form-body">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered table-stypeed table-responsive">
                                ...
                                @foreach($partners as $partner)
                                    <tr>
                                        <td><img src="{{asset('storage/uploads/partners/'.$partner->image)}}" height="150px;" width="150p;"></td>
                                        <td>{{$partner->created_at->diffForHumans()}}</td>
                                        <td>
                                            <a href="{{route('admin.partners.edit' ,['id' => $partner->id])}}" class="btn btn-success" >
                                                <i class="fa fa-edit"></i>
                                                تعديل
                                            </a>
                                            <button type="button" class="btn btn-danger btndelet" data-url="{{route('admin.partners.delete' ,['id'=>$partner->id])}}" >
