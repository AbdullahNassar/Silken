            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        <form  action="{{ route('admin.clients.edit' ,['id'=>$client->id])}}" enctype="multipart/form-data" method="post"  onsubmit="return false;">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                <div class="row" style="margin-left: 50px;">
                                    <div class="form-group col-sm-12 col-md-12 ">
                                        ...
                                        <div class="col-md-9 col-sm-9 file-box">
                                            <img src="{{asset('storage/uploads/clients/'.$client->image)}}" class="img-responsive mr-bot-15 profile-user-img  btn-product-image "
