...
@section('content')
    <div class="page-content">
        <form action="{{ route('site.orders.create') }}" id="payment-form" method="post" onsubmit="return false;">
                        ...
                        <div class="toggle-container" id="accordion1">
                            <div class="panel">
                                ...
                                <div class="panel-collapse collapse in" id="accord1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" name="f_name" placeholder="First Name" type="text" value="{{ $user->f_name }}">
                                                    </input>
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" name="l_name" placeholder="Last Name" type="text" value="{{ $user->l_name }}">
                                                </input>
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control" name="phone" placeholder="Phone" type="text" value="{{ $user->phone }}">
                                            </input>
                                        </div>
                                    </div>
                                    <!--End col-md-6-->
                                    ...
                                    <!--End form-group-->
                                    <div class="form-group">
                                        <input class="form-control" name="address" placeholder="Address" type="text" value="{{ $user->address }}">
                                    </input>
                                </div>
                                <div class="form-group">
                            ...
                            <tbody>
                                @foreach ($basket->all() as $item)
                                    ...
                                    <td class="product-price">
                                        ${{ num_format($item->getDiscount()) }}
                                    </td>
                                    <td class="product-quantity">
                                        {{ $item->quantity }}
                                    </td>
                                    <td class="product-subtotal">
                                        ${{num_format($item->getTotal())}}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
