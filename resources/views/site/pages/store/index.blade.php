                                        ...
                                        <div class="panel-collapse collapse" id="{{$category->id}}">
                                            <form class="{{route('site.store')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="panel next-level">
                                                        <a href="#service1-{{ $sub->id }}" data-toggle="collapse" data-parent="#service1" class="collapsed">
                                                            {{ "$SubCat->name" }}
                                                        </a>
                                                        <div class="panel-collapse collapse" id="service1-{{ $sub->id }}">
                                                            <div class="panel-content">
                                                                @foreach ($sub->subCategories as $subsub)
                                                                @php

                                                                $SubsubCat = $subsub->translated(app()->getLocale());
                                                                @endphp

                                                                <div class="form-group">
                                                                    <div class="radio-check-item">
                                                                        <input type="checkbox" name="categories[{{ $subsub->id }}]" class="form-control categoriy-input" value="{{ $subsub->id }}" id="cat-{{ $subsub->id }}">
                                                                        
                                                                        <label for="cat-{{ $subsub->id }}">
                                                                            {{ "$SubsubCat->name" }}
                                                                        </label>
                                                    ...
                                                    <div class="radio-check-item">
                                                        ...
                                                        <label for="cat-{{ $sub->id }}">
                                                            {{ "$SubCat->name" }}{{count($sub->subCategories)}}
                                                        </label>
                                                    </div><!-- End Radio-Check-Item -->
                                                    @endif
